...
public class SqlInsert extends TableBuilderCommand {
	...
	/**
	 * This method is a convenience method used to add the relevant columns from the table to the
	 * insert statement. Note that columns that are typically generated by the database (e.g. ID
	 * columns) are not added to the statement.
	 */
	public void addColumnsForTable() {
		Iterator<Column> iterColumns = m_table.getColumns();
