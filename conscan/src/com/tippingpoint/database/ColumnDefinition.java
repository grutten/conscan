...
public class ColumnDefinition extends Element implements Column {
	...
	/**
	 * This method returns if the type dictates if the value is required when the column is
	 * required. Values not required when the column type indicates that the column is specified are
	 * values generated by the database (i.e. id columns).
	 */
