...
public class TestParser extends TestDbCase {
	private static final String[] DB =
		{"<?xml version=\"1.0\" encoding=\"UTF-8\"?>", "<Schema name=\"testparserschema\">",
				"  <Table name=\"demographic\">", "    <Column name=\"demographicid\" type=\"id\"/>",
				"    <Column name=\"firstName\" type=\"string\" length=\"100\"/>",
				"    <Column name=\"lastName\" type=\"string\" length=\"100\"/>",
				"    <Column name=\"creation\" type=\"date\"/>",
				"    <Constraint name=\"pk_demographic\" type=\"primary\">", "      <Column name=\"demographicid\"/>",
				"    </Constraint>", "  </Table>", "  <Table name=\"role\">",
				"    <Column name=\"roleid\" type=\"id\"/>",
				"    <Column name=\"name\" type=\"string\" length=\"200\"/>",
				"    <Constraint name=\"pk_role\" type=\"primary\">", "      <Column name=\"roleid\"/>",
				"    </Constraint>", "  </Table>", "  <Table name=\"tagtype\">",
				"    <Column name=\"tagtypeid\" type=\"id\"/>",
				"    <Column name=\"text\" type=\"string\" length=\"200\"/>",
				"    <Constraint name=\"pk_tagtype\" type=\"primary\">", "      <Column name=\"tagtypeid\"/>",
				"    </Constraint>", "  </Table>", "  <Table name=\"tag\">",
				"    <Column name=\"tagid\" type=\"id\"/>", "    <Column name=\"tagtypeid\" type=\"idref\"/>",
				"    <Column name=\"text\" type=\"string\" length=\"200\"/>",
				"    <Constraint name=\"pk_tag\" type=\"primary\">", "      <Column name=\"tagid\"/>",
				"    </Constraint>", "    <Constraint name=\"fk_tag_tagtype\" type=\"foreign\">",
				"      <Column name=\"tagtypeid\"/>", "      <Table name=\"tagtype\">",
				"        <Column name=\"tagtypeid\"/>", "      </Table>", "    </Constraint>", "  </Table>",
				"  <Table name=\"roletag\">", "    <Column name=\"roleid\" type=\"idref\" required=\"true\"/>",
				"    <Column name=\"tagid\" type=\"idref\" required=\"true\"/>",
				"    <Constraint name=\"fk_roletag_role\" type=\"foreign\">", "      <Column name=\"roleid\"/>",
				"      <Table name=\"role\">", "        <Column name=\"roleid\"/>", "      </Table>",
				"    </Constraint>", "    <Constraint name=\"fk_roletag_tag\" type=\"foreign\">",
				"      <Column name=\"tagid\"/>", "      <Table name=\"tag\">", "        <Column name=\"tagid\"/>",
				"      </Table>", "    </Constraint>", "  </Table>", "  <Table name=\"activity\">",
				"    <Column name=\"activityid\" type=\"id\"/>",
				"    <Column name=\"title\" type=\"string\" length=\"200\"/>",
				"    <Column name=\"description\" type=\"text\"/>", "    <Column name=\"creation\" type=\"date\"/>",
				"    <Column name=\"lastmodified\" type=\"date\"/>",
				"    <Constraint name=\"pk_activity\" type=\"primary\">", "      <Column name=\"activityid\"/>",
				"    </Constraint>", "  </Table>", "</Schema>"};

	private static final String[] DB_DATA =
		{"<data>", "  <Table name=\"demographic\">", "    <item>", "      <Column name=\"username\">tester</Column>",
				"      <Column name=\"password\">password</Column>",
				"      <Column name=\"email\">test@system.com</Column>",
				"      <Column name=\"firstName\">Test</Column>",
				"      <Column name=\"lastName\">Administration</Column>", "    </item>", "  </Table>",
				"  <Table name=\"tagtype\">", "    <item>", "      <Column name=\"text\">Security</Column>",
				"    </item>", "  </Table>", "  <Table name=\"tag\">", "    <item>",
				"      <Column name=\"text\">Public</Column>",
				"      <Column name=\"tagtypeid\" value=\"referenced\">", "        <Table name=\"tagtype\">",
				"          <Column name=\"text\">Security</Column>", "        </Table>", "      </Column>",
				"    </item>", "  </Table>", "  <Table name=\"role\">", "    <item>",
				"      <Column name=\"name\">Administrator</Column>", "    </item>", "  </Table>", "</data>"};
