...
/**
 * This class serves the staff related objects.
 */
public class Staff extends Services {
	private static Log m_log = LogFactory.getLog(Staff.class);
	private static final long serialVersionUID = 6661798263642526305L;

	/**
	 * This method executes the get command; which is used to return the contents of a staff.
	 * 
	 * @throws IOException
	 */
	@Override
		...
		if (listElements != null && !listElements.isEmpty()) {
			...
			if (builder != null) {
				try {
					...
					m_log.error("Database error retrieving staff object.", e);
